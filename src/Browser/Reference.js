...
export function Reference({ 창닫기 }) {
  ...
  const showBookmarks = () => {
    setBookmarks(prevShow => !prevShow);
  }
    ...
    <Window id="Reference" tabText="Reference" 닫기={창닫기}>
      <main>
        ...
        <aside>
          ...
          <nav style={{ display: submenu ? 'flex' : 'none' }}>
          ...
          <div id="copyright">
            <span>
              <img src="https://ccl.cckorea.org/images/licenses/by-green.png" alt="copyrightImg" />
              <img src="https://ccl.cckorea.org/images/licenses/nc-green.png" alt="copyrightImg" />
              <img src="https://ccl.cckorea.org/images/licenses/sa-green.png" alt="copyrightImg" />
            </span>
            <h6>all copyrights reserved by s_leepywood</h6>
          </div>
        </aside>
        <article>
          <div>
      ...
      <button class="bar" onClick={showBookmarks}></button>
    </Window>
  )
}