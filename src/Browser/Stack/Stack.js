...
import { 
  ...
  ChipTool,
  ChipETC,
} from "./Component/Stack_Chip"
import { StackChip } from "./Component/Stack_StackChip";
...
function StackFilters({ onFilterChange }) {
  const filters = [
    { label: "전체", value: "전체" },
    { label: "익숙해요", value: "ChipFamiliar" },
    { label: "배우고 있어요", value: "ChipLearning" },
    { label: "사용해 봤어요", value: "ChipDone" },
    { label: "프레임워크", value: "ChipFramework" },
    { label: "라이브러리", value: "ChipLibrary" },
    { label: "협업", value: "ChipCoWorking" },
    { label: "툴", value: "ChipTool" },
  ];
...
function StackContainer({ filter }) {
  const stackChips = [
    {
    ...
    },
    {
      ...
      chips: [<ChipFamiliar />, <ChipLearning />]
    },
    {
    ...
    },
    {
      ...
      chips: [<ChipLibrary />, <ChipFamiliar />]
    },
    {
      ...
      chips: [<ChipCoWorking />, <ChipTool />, <ChipFamiliar />]
    },
    {
      ...
      chips: [<ChipCoWorking />, <ChipFamiliar />]
    },
    {
    ...
    },
    {
      ...
      chips: [<ChipTool />, <ChipDone />, <ChipLearning />, ]
    },
    {
